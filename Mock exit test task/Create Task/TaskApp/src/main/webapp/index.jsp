...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Task Creation</a>
			<button
	...
	<section class="page-section" id="task">
		<div class="container">
			...
			<h2	class="page-section-heading text-center text-uppercase text-secondary mb-0">Create task</h2>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					<form id="taskform" data-sb-form-api-token="API_TOKEN">
						<!-- Title input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="name" type="text"
								placeholder="Enter title..." data-sb-validations="required" />
							<label for="name">Task Title</label>
							<div class="invalid-feedback" data-sb-feedback="name:required">Task title is required.</div>
						</div>
						<!-- description input-->
						<div class="form-floating mb-3">
							<textarea class="form-control" id="message" type="text"
								placeholder="Enter description here..." style="height: 10rem"
						...
						<!-- Due date input-->
						<div class="form-floating mb-3">
							<input class="form-control" id="dueDate" name="dueDate" type="date" placeholder="Due Date" data-sb-validations="required" />
							<label for="dueDate">Due Date</label>
							<div class="invalid-feedback" data-sb-feedback="dueDate:required">A due date is required.</div>
						</div>
						<!-- priority input-->
						<div class="form-floating mb-3">
	        				<select class="form-select" id="priority" name="priority" data-sb-validations="required">
        					...
        					<div class="invalid-feedback" data-sb-feedback="priority:required">Priority is required.</div>
    					</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        Hyderguda, Attapur <br /> Hyderabad, Teleangana - 500048.
                    </p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="col-lg-4">
                    ...
                    <p class="lead mb-0">
                        MIT licensed Bootstrap theme created by <a href="http://startbootstrap.com">Start Bootstrap</a>.
                    </p>
                </div>
            </div>
        </div>
